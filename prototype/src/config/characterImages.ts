...
export const CHARACTER_IMAGES: Record<string, CharacterImageSet> = {
  ...
  'es-isabella': {
    idle: {
      src: '/characters/es/isabella/idle.png',
      width: 320,
      height: 440,
      scale: 0.8,
      offsetY: -68,
    ...
    dance: {
      src: '/characters/es/isabella/dance.png',
      width: 340,
      height: 460,
      scale: 0.8,
      offsetY: -78,
    ...
    spin: {
      src: '/characters/es/isabella/spin.png',
      width: 340,
      height: 460,
      scale: 0.8,
      offsetY: -78,
    ...
    clap: {
      src: '/characters/es/isabella/clap.png',
      width: 320,
      height: 440,
      scale: 0.8,
      offsetY: -68,
  ...
  'es-carlos': {
    idle: {
      src: '/characters/es/carlos/idle.png',
      width: 280,
      height: 400,
      scale: 0.9,
      offsetY: -55,
    ...
    wave: {
      src: '/characters/es/carlos/wave.png',
      width: 280,
      height: 400,
      scale: 0.9,
      offsetY: -55,
    ...
    jump: {
      src: '/characters/es/carlos/jump.png',
      width: 280,
      height: 420,
      scale: 0.9,
      offsetY: -65,
  ...
  'es-luna': {
    idle: {
      src: '/characters/es/luna/idle.png',
      width: 290,
      height: 410,
      scale: 0.85,
      offsetY: -58,
    ...
    pose: {
      src: '/characters/es/luna/pose.png',
      width: 290,
      height: 410,
      scale: 0.85,
      offsetY: -58,
